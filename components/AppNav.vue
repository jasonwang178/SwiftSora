<template>
  <nav class="fixed z-30 w-full shadow-md hover:shadow-lg bg-opacity-60 backdrop-filter backdrop-blur-md bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
          ...
          <div class="flex items-center ml-3">
            <div>
              <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button-2" aria-expanded="false" data-dropdown-toggle="dropdown-2">
                ...
                <img class="w-8 h-8 rounded-full" src="/profile.jpg" alt="user photo" />
              </button>
            </div>
            ...
            <div class="hidden z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-2">
              <div class="py-3 px-4" role="none">
                <p class="text-sm text-gray-900 dark:text-white" role="none">Test User</p>
                <p class="text-sm font-medium text-gray-900 truncate dark:text-gray-300" role="none">support@swiftsora.com</p>
              </div>
              <ul class="py-1" role="none">
                <li>
                  <NuxtLink to="/app/settings" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">
                    <Icon name="solar:settings-bold" class="w-5 h-5 mr-1 mb-0.5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" />
                ...
                <li>
                  ...
                  <NuxtLink to="/" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">
                    <Icon name="ic:baseline-logout" class="w-5 h-5 mr-1 mb-0.5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" />
                    <span>Sign out</span></NuxtLink>
                </li>
              </ul>
            </div>
          </div>
